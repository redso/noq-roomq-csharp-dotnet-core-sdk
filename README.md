...
```shell
// Install via shell
PM> Install-Package NoQ.RoomQ.DotNet.Core.3.1.SDK
...
{
    public class RoomQController : ControllerBase
    {
...
| Version | Nuget           | .Net Core Version |
| ------- | --------------- | ---------------------- |
| 1.x     | `NoQ.RoomQ.DotNet.Core.3.1.SDK` | 3.1                    |
